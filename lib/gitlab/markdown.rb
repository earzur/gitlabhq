module Gitlab
  ...
  module Markdown
    ...
    def gfm(text, html_options = {})
      ...
      sanitize text.html_safe, attributes: ActionView::Base.sanitized_allowed_attributes + %w(id class), tags: ActionView::Base.sanitized_allowed_tags + %w(table tr td th thead tbody)
    end
